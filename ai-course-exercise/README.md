...
Generated plots:
1. **feature_distributions.png**: Histograms of all 4 features by 3 species
2. **feature_relationships.png**: Scatter plots of feature pairs
3. **confusion_matrix_custom.png**: Custom implementation results
4. **confusion_matrix_sklearn.png**: Scikit-learn results
5. **confusion_matrices_comparison.png**: Side-by-side comparison
6. **accuracy_comparison.png**: Bar chart comparing both implementations
7. **learned_distributions.png**: 4×3 grid showing learned Gaussian distributions
